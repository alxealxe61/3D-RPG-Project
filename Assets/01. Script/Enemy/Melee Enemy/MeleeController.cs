...
namespace _01._Script.Enemy.Melee_Enemy
{
    public class MeleeController : MonoBehaviour
    {
        ...
        public readonly List<MeleeState> Patterns = new List<MeleeState>();
        ...
        public MeleeMovestate MeleeMovestate { get; private set; }
        public MeleeStunState MeleeStunState { get; private set; }
        ...
        void Awake()
        {
            ...
            MeleeIdleState = new MeleeIdleState(this, StateMachine, "CombatIdle", false);
            MeleeMovestate = new MeleeMovestate(this, StateMachine, "CombatMove", false);
            MeleeStunState = new MeleeStunState(this, StateMachine, "CombatStun", false);
